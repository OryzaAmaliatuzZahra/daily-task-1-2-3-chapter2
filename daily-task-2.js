...
console.log("--- No 1---")
let filterNo1 = person.filter(x => {
    return parseInt(x.registered.substring(0, 4)) < 2022
})
console.log(filterNo1)
...
console.log("")
console.log("--- No 5---")
let filterNo5 = person.filter(x=>{
    return x.friends.filter(y=>{
        return y.gender==="male" && y.hobby==="basketball"
    })
  })
console.log(filterNo5)
...
console.log("")
console.log("--- No 7---")
// let filterFriendName = person.map(x => {
//     return x.friends.filter(z => {
//         return z.name == "Theresia"
//     })
// })
// console.log(filterFriendName)
